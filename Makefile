...
QA        = docker run --rm -v `pwd`:/project mykiwi/phaudit
...
.PHONY: lint lt ly phpstan phploc pdepend phpmd php_codesnifer phpcpd phpdcd phpmetrics php-cs-fixer apply-php-cs-fixer artefacts
